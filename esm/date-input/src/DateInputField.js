...
var DateInputField = /*#__PURE__*/memo( /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  var _splitBoxProps = splitBoxProps(restProps),
      ...
      remainingProps = _splitBoxProps.remainingProps; // Date input CANNOT have children!
  ...
  return /*#__PURE__*/React.createElement(FormField, _extends({
    ...
    labelFor: id
  }, matchedProps), /*#__PURE__*/React.createElement(DateInput, _extends({
    id: id,
    width: inputWidth,
    height: inputHeight,
    disabled: disabled,
...
DateInputField.propTypes = _objectSpread(_objectSpread(_objectSpread({}, DateInput.propTypes), FormField.propTypes), {}, {
  /**
